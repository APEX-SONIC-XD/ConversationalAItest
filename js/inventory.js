...
const BASE_VEHICLES = [
  ...
  {
    id: 40, stockNum: 'DC10040', vin: '1C4HJXDG5JW123456',
    year: 2018, make: 'Jeep', model: 'Wrangler', trim: 'Unlimited Sport',
    body: 'SUV', extColor: 'Granite Crystal Metallic', intColor: 'Black',
    price: 31990, mileage: 47200, mpgCity: 17, mpgHwy: 25,
    engine: '3.6L V6', hp: 285,
    transmission: '8-Speed Automatic', drivetrain: '4WD',
    owners: 1, accidentFree: true,
    dealBadge: 'great-deal', dealLabel: 'Pre-Owned', marketSavings: 1200,
    features: ['Bluetooth Hands-Free','Apple CarPlay / Android Auto',
      'Removable Hard Top','4-Door Unlimited','Uconnect 4','Backup Camera',
      'Trail Rated 4WD','All-Terrain Tires','SiriusXM','Push-Button Start','Carfax 1-Owner'],
    images: [SKETCH_IMG, SKETCH_IMG, SKETCH_IMG],
    description: 'A used 2018 Wrangler Unlimited Sport — 4-door, Bluetooth, and the removable hard top ready for Queens streets or weekend trails.',
    location: 'Jamaica, NY'
  },
  {
    id: 41, stockNum: 'DC10041', vin: '1C4HJXEN5KW234567',
    year: 2019, make: 'Jeep', model: 'Wrangler', trim: 'Unlimited Willys',
    body: 'SUV', extColor: 'Sting-Gray Clearcoat', intColor: 'Black',
    price: 34490, mileage: 41800, mpgCity: 17, mpgHwy: 25,
    engine: '3.6L V6', hp: 285,
    transmission: '8-Speed Automatic', drivetrain: '4WD',
    owners: 1, accidentFree: true,
    dealBadge: 'great-deal', dealLabel: 'CPO', marketSavings: 1100,
    features: ['Jeep Certified Pre-Owned','Bluetooth Audio Streaming','Apple CarPlay / Android Auto',
      'Removable Hard Top','4-Door Unlimited','Willys Off-Road Package','Rock Rails',
      'Trail Rated 4WD','All-Terrain Tires','Backup Camera','Uconnect 4'],
    images: [SKETCH_IMG, SKETCH_IMG, SKETCH_IMG],
    description: 'Trail-ready Willys styling on a CPO 2019 Wrangler Unlimited — 4-door, Bluetooth, and a bolt-off hard top inspected to Jeep certified standards.',
    location: 'Flushing, NY'
  },
  {
    id: 42, stockNum: 'DC10042', vin: '1C4HJXDG5LW345678',
    year: 2020, make: 'Jeep', model: 'Wrangler', trim: 'Unlimited Sport S',
    body: 'SUV', extColor: 'Firecracker Red Clearcoat', intColor: 'Black',
    price: 33990, mileage: 35200, mpgCity: 17, mpgHwy: 25,
    engine: '3.6L V6', hp: 285,
    transmission: '8-Speed Automatic', drivetrain: '4WD',
    owners: 1, accidentFree: true,
    dealBadge: 'hot-deal', dealLabel: 'Pre-Owned', marketSavings: 1400,
    features: ['Bluetooth & Voice Command','Apple CarPlay / Android Auto',
      'Removable Hard Top','4-Door Unlimited','Sport S Package','Backup Camera',
      'Trail Rated 4WD','Uconnect 4','SiriusXM','Heated Mirrors','Carfax 1-Owner'],
    images: [SKETCH_IMG, SKETCH_IMG, SKETCH_IMG],
    description: 'A used 2020 Wrangler Unlimited Sport S — Bluetooth, 4-door layout, and the removable hard top package buyers search for in the NYC metro.',
    location: 'Brooklyn, NY'
  },
  {
    id: 43, stockNum: 'DC10043', vin: '1C4HJXEN5MW456789',
    year: 2021, make: 'Jeep', model: 'Wrangler', trim: 'Unlimited Sahara',
    body: 'SUV', extColor: 'Sarge Green Clearcoat', intColor: 'Black',
    price: 38490, mileage: 28400, mpgCity: 17, mpgHwy: 25,
    engine: '3.6L V6', hp: 285,
    transmission: '8-Speed Automatic', drivetrain: '4WD',
    owners: 1, accidentFree: true,
    dealBadge: 'great-deal', dealLabel: 'CPO', marketSavings: 1900,
    features: ['Jeep Certified Pre-Owned','Bluetooth Hands-Free','Apple CarPlay / Android Auto',
      'Removable Hard Top','Power Sky One-Touch Top','4-Door Unlimited','Leather-Trimmed Seats','Heated Front Seats',
      'Alpine Premium Audio','Backup Camera','Trail Rated 4WD','Uconnect 4 NAV'],
    images: [SKETCH_IMG, SKETCH_IMG, SKETCH_IMG],
    description: 'A well-optioned 2021 Wrangler Unlimited Sahara — Jeep CPO, Bluetooth, removable hard top, and the newest year in the 2015–2022 sweet spot.',
    location: 'Queens, NY'
  },
  {
    id: 44, stockNum: 'DC10044', vin: '1C4HJXDG5NW567890',
    year: 2022, make: 'Jeep', model: 'Wrangler', trim: 'Unlimited Sahara Altitude',
    body: 'SUV', extColor: 'Bright White Clearcoat', intColor: 'Black',
    price: 41990, mileage: 22100, mpgCity: 17, mpgHwy: 25,
    engine: '3.6L V6', hp: 285,
    transmission: '8-Speed Automatic', drivetrain: '4WD',
    owners: 1, accidentFree: true,
    dealBadge: 'low-miles', dealLabel: 'CPO', marketSavings: 1600,
    features: ['Jeep Certified Pre-Owned','Bluetooth & Wireless Audio','Apple CarPlay / Android Auto',
      'Removable Hard Top','Power Sky One-Touch Top','4-Door Unlimited','Leather-Trimmed Seats','Altitude Package','Heated Front Seats',
      'Backup Camera','Trail Rated 4WD','Uconnect 5 NAV','LED Headlamps','Push-Button Start'],
    images: [SKETCH_IMG, SKETCH_IMG, SKETCH_IMG],
    description: 'Low-mile 2022 Wrangler Unlimited Sahara Altitude — top of the requested year range, CPO inspected, Bluetooth, and removable hard top.',
    location: 'Long Island City, NY'
  },
  {
    id: 45, stockNum: 'DC10045', vin: '1C4HJXDG5KW789012',
    year: 2019, make: 'Jeep', model: 'Wrangler', trim: 'Unlimited Sport Soft Top',
    body: 'SUV', extColor: 'Ocean Blue Metallic', intColor: 'Black',
    price: 28990, mileage: 43800, mpgCity: 17, mpgHwy: 25,
    engine: '3.6L V6', hp: 285,
    transmission: '8-Speed Automatic', drivetrain: '4WD',
    owners: 1, accidentFree: true,
    dealBadge: 'great-deal', dealLabel: 'Pre-Owned', marketSavings: 2100,
    features: ['Bluetooth Hands-Free','Apple CarPlay / Android Auto',
      'Premium Soft Top','4-Door Unlimited','Uconnect 4','Backup Camera',
      'Trail Rated 4WD','SiriusXM','Push-Button Start','Carfax 1-Owner'],
    images: [SKETCH_IMG, SKETCH_IMG, SKETCH_IMG],
    description: 'Best KBB value in the Unlimited lineup here — 2019 Sport with premium soft top, Bluetooth, and 4-door layout for about $3k less than comparable hard-top models.',
    location: 'Astoria, NY'
  },
  {
    id: 46, stockNum: 'DC10046', vin: '1C4BJWDG5FL123456',
    year: 2015, make: 'Jeep', model: 'Wrangler', trim: 'Unlimited Sport',
    body: 'SUV', extColor: 'Anvil Clearcoat', intColor: 'Black',
    price: 23990, mileage: 68200, mpgCity: 16, mpgHwy: 21,
    engine: '3.6L V6', hp: 285,
    transmission: '5-Speed Automatic', drivetrain: '4WD',
    owners: 1, accidentFree: true,
    dealBadge: 'great-deal', dealLabel: 'Pre-Owned', marketSavings: 1800,
    features: ['Bluetooth Hands-Free','Uconnect Bluetooth',
      'Removable Hard Top','4-Door Unlimited','Backup Camera',
      'Trail Rated 4WD','All-Terrain Tires','SiriusXM','Carfax 1-Owner'],
    images: [SKETCH_IMG, SKETCH_IMG, SKETCH_IMG],
    description: 'Lowest-priced Unlimited in the expanded search — 2015 Sport with Bluetooth and removable hard top, often the best PA-market deal for budget-first shoppers.',
    location: 'Reading, PA'
  },
  {
    id: 47, stockNum: 'DC10047', vin: '1C4BJWDG5GL234567',
    year: 2016, make: 'Jeep', model: 'Wrangler', trim: 'Unlimited Sport',
    body: 'SUV', extColor: 'Black Clearcoat', intColor: 'Black',
    price: 25990, mileage: 59800, mpgCity: 16, mpgHwy: 21,
    engine: '3.6L V6', hp: 285,
    transmission: '5-Speed Automatic', drivetrain: '4WD',
    owners: 1, accidentFree: true,
    dealBadge: 'great-deal', dealLabel: 'Pre-Owned', marketSavings: 1500,
    features: ['Bluetooth Audio Streaming','Uconnect Bluetooth',
      'Removable Hard Top','4-Door Unlimited','Backup Camera',
      'Trail Rated 4WD','All-Terrain Tires','SiriusXM','Push-Button Start'],
    images: [SKETCH_IMG, SKETCH_IMG, SKETCH_IMG],
    description: 'A 2016 Wrangler Unlimited Sport — 4-door, Bluetooth, and bolt-off hard top at a mid-range ask between the 2015 budget picks and newer JL models.',
    location: 'Allentown, PA'
  },
  {
    id: 48, stockNum: 'DC10048', vin: '1C4BJWDG5HL345678',
    year: 2017, make: 'Jeep', model: 'Wrangler', trim: 'Unlimited Willys Wheeler',
    body: 'SUV', extColor: 'Rhino Clearcoat', intColor: 'Black',
    price: 27490, mileage: 52100, mpgCity: 16, mpgHwy: 21,
    engine: '3.6L V6', hp: 285,
    transmission: '5-Speed Automatic', drivetrain: '4WD',
    owners: 1, accidentFree: true,
    dealBadge: 'hot-deal', dealLabel: 'Pre-Owned', marketSavings: 1300,
    features: ['Bluetooth Hands-Free','Uconnect Bluetooth',
      'Removable Hard Top','4-Door Unlimited','Willys Wheeler Package',
      'Rock Rails','Trail Rated 4WD','All-Terrain Tires','Backup Camera','SiriusXM'],
    images: [SKETCH_IMG, SKETCH_IMG, SKETCH_IMG],
    description: 'Trail-ready 2017 Willys Wheeler Unlimited — Bluetooth, hard top, and off-road hardware without the newer-JL price bump.',
    location: 'Philadelphia, PA'
  },
  {
    id: 49, stockNum: 'DC10049', vin: '1C4HJXEN5LW678901',
    year: 2020, make: 'Jeep', model: 'Wrangler', trim: 'Unlimited Sahara',
    body: 'SUV', extColor: 'Billet Silver Metallic', intColor: 'Black',
    price: 36490, mileage: 38900, mpgCity: 17, mpgHwy: 25,
    engine: '3.6L V6', hp: 285,
    transmission: '8-Speed Automatic', drivetrain: '4WD',
    owners: 1, accidentFree: true,
    dealBadge: 'great-deal', dealLabel: 'Pre-Owned', marketSavings: 1700,
    features: ['Bluetooth Hands-Free','Apple CarPlay / Android Auto',
      'Removable Hard Top','Power Sky One-Touch Top','4-Door Unlimited','Leather-Trimmed Seats','Heated Front Seats',
      'Alpine Premium Audio','Backup Camera','Trail Rated 4WD','Uconnect 4 NAV'],
    images: [SKETCH_IMG, SKETCH_IMG, SKETCH_IMG],
    description: 'Loaded 2020 Wrangler Unlimited Sahara — leather, navigation, and the power sunroof top buyers ask for, at a lower ask than newer Sahara inventory.',
