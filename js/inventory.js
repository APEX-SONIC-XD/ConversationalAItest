...
const BASE_VEHICLES = [
  ...
  {
    id: 40, stockNum: 'DC10040', vin: 'JTDBCMFE0P3012345',
    year: 2023, make: 'Toyota', model: 'Corolla', trim: 'LE',
    body: 'Sedan', extColor: 'Celestial Silver Metallic', intColor: 'Gray',
    price: 26488, mileage: 22400, mpgCity: 53, mpgHwy: 46,
    engine: '1.8L Hybrid 4-Cyl', hp: 138,
    transmission: 'eCVT', drivetrain: 'AWD',
    owners: 1, accidentFree: true,
    priorUse: 'off-lease', formerLease: true, formerRental: false, formerFleet: false,
    source: 'Toyota Financial Services lease return — upstate NY',
    dealBadge: 'great-deal', dealLabel: 'Great Deal', marketSavings: 1100,
    features: ['Toyota Safety Sense 3.0','Apple CarPlay / Android Auto','Hybrid AWD',
      'Heated Front Seats','Blind Spot Monitor','Rear Cross-Traffic Alert',
      'LED Headlights','Smart Key System','Wireless Phone Charger','All-Wheel Drive'],
    images: [SKETCH_IMG, SKETCH_IMG, SKETCH_IMG],
    description: 'This 2023 Toyota Corolla LE Hybrid AWD pairs 50+ mpg combined with electric-assist all-wheel drive — a rare combo for Rochester winters without stepping up to a larger SUV.',
    location: 'Rochester, NY'
  },
  {
    id: 41, stockNum: 'DC10041', vin: '4S3BWAC64N3012345',
    year: 2022, make: 'Subaru', model: 'Legacy', trim: 'Premium',
    body: 'Sedan', extColor: 'Crystal Black Silica', intColor: 'Black',
    condition: 'used',
    price: 27988, mileage: 26500, mpgCity: 27, mpgHwy: 35,
    engine: '2.5L 4-Cylinder', hp: 182,
    transmission: 'CVT Lineartronic', drivetrain: 'AWD',
    owners: 1, accidentFree: true,
    priorUse: 'off-lease', formerLease: true, formerRental: false, formerFleet: false,
    source: 'Subaru Motors Finance off-lease — Syracuse area',
    dealBadge: 'great-deal', dealLabel: 'Great Deal', marketSavings: 1500,
    features: ['EyeSight Driver Assist','Apple CarPlay / Android Auto','Symmetrical AWD',
      'Heated Front Seats','Power Moonroof','Blind Spot Detection',
      'Rear Cross-Traffic Alert','All-Weather Package','LED Steering Responsive Headlights','All-Wheel Drive'],
    images: [SKETCH_IMG, SKETCH_IMG, SKETCH_IMG],
    description: 'This 2022 Subaru Legacy Premium brings standard Symmetrical AWD to a right-sized sedan — strong winter confidence for Rochester with more rear-seat room than a Corolla.',
    location: 'Pittsford, NY'
  },
  {
    id: 42, stockNum: 'DC10042', vin: '4T1G11AK8NU123456',
    year: 2022, make: 'Toyota', model: 'Camry', trim: 'LE AWD',
    body: 'Sedan', extColor: 'Wind Chill Pearl', intColor: 'Black',
    price: 28488, mileage: 24100, mpgCity: 28, mpgHwy: 39,
    engine: '2.5L 4-Cylinder', hp: 203,
    transmission: '8-Speed Automatic', drivetrain: 'AWD',
    owners: 1, accidentFree: true,
    dealBadge: 'great-deal', dealLabel: 'Great Deal', marketSavings: 1700,
    features: ['Toyota Safety Sense 2.5+','Apple CarPlay / Android Auto','All-Wheel Drive',
      'Heated Front Seats','Dual-Zone Climate Control','Blind Spot Monitor',
      'Rear Cross-Traffic Alert','LED Headlights','Smart Key System','8" Touchscreen'],
    images: [SKETCH_IMG, SKETCH_IMG, SKETCH_IMG],
    description: 'This 2022 Toyota Camry LE AWD adds all-weather traction to Toyota\'s midsize sedan — more rear-seat room than the Corolla Hybrid with Rochester-ready AWD.',
    location: 'Henrietta, NY'
  },
  {
    id: 43, stockNum: 'DC10043', vin: '4S3BWAN68R4012345',
    year: 2024, make: 'Subaru', model: 'Legacy', trim: 'Premium',
    body: 'Sedan', extColor: 'Crystal White Pearl', intColor: 'Black',
    condition: 'used',
    price: 28988, mileage: 18200, mpgCity: 27, mpgHwy: 35,
    engine: '2.5L 4-Cylinder', hp: 182,
    transmission: 'CVT Lineartronic', drivetrain: 'AWD',
    owners: 1, accidentFree: true,
    dealBadge: 'low-miles', dealLabel: 'Low Miles', marketSavings: 1400,
    features: ['EyeSight Driver Assist','Apple CarPlay / Android Auto','Symmetrical AWD',
      'Heated Front Seats','Power Moonroof','Blind Spot Detection',
      'All-Weather Package','LED Steering Responsive Headlights','All-Wheel Drive'],
    images: [SKETCH_IMG, SKETCH_IMG, SKETCH_IMG],
    description: 'Used 2024 Legacy Premium — one of the last model years before discontinuation, low miles and standard AWD for Rochester lake-effect seasons.',
    location: 'Webster, NY'
  },
  {
    id: 44, stockNum: 'DC10044', vin: '4T1K61AK8RU123456',
    year: 2024, make: 'Toyota', model: 'Camry', trim: 'LE AWD',
    body: 'Sedan', extColor: 'Midnight Black Metallic', intColor: 'Black',
    price: 29488, mileage: 16800, mpgCity: 28, mpgHwy: 39,
    engine: '2.5L 4-Cylinder', hp: 203,
    transmission: '8-Speed Automatic', drivetrain: 'AWD',
    owners: 1, accidentFree: true,
    dealBadge: 'great-deal', dealLabel: 'Great Deal', marketSavings: 1600,
    features: ['Toyota Safety Sense 2.5+','Apple CarPlay / Android Auto','All-Wheel Drive',
      ...
      'Rear Cross-Traffic Alert','LED Headlights','Smart Key System','8" Touchscreen'],
    images: [SKETCH_IMG, SKETCH_IMG, SKETCH_IMG],
    description: '2024 Camry LE AWD with under 17k miles — newer model year, more rear seat room, and still under $30k.',
    location: 'Brighton, NY'
  },
  {
    id: 45, stockNum: 'DC10045', vin: 'JTDBCMFE9R5012345',
    year: 2025, make: 'Toyota', model: 'Corolla', trim: 'LE',
    body: 'Sedan', extColor: 'Blueprint', intColor: 'Gray',
    condition: 'new',
    price: 29888, mileage: 12, mpgCity: 53, mpgHwy: 46,
    engine: '1.8L Hybrid 4-Cyl', hp: 138,
    transmission: 'eCVT', drivetrain: 'AWD',
    owners: 1, accidentFree: true,
    dealBadge: 'low-miles', dealLabel: 'Low Miles', marketSavings: 1200,
    features: ['Toyota Safety Sense 3.0','Apple CarPlay / Android Auto','Hybrid AWD',
      'Heated Front Seats','Blind Spot Monitor','Rear Cross-Traffic Alert',
      'Wireless Phone Charger','Smart Key System','All-Wheel Drive'],
    images: [SKETCH_IMG, SKETCH_IMG, SKETCH_IMG],
    description: '2025 Corolla LE Hybrid AWD — lowest miles on the lot in your budget band with the same 50+ mpg hybrid AWD formula.',
    location: 'Victor, NY'
  },
  {
    id: 46, stockNum: 'DC10046', vin: 'JF1SKAC64R8123456',
    year: 2025, make: 'Subaru', model: 'Impreza', trim: 'Premium',
    body: 'Sedan', extColor: 'Crystal White Pearl', intColor: 'Black',
    condition: 'new',
    price: 29488, mileage: 18, mpgCity: 28, mpgHwy: 36,
    engine: '2.5L 4-Cylinder', hp: 182,
    transmission: 'CVT Lineartronic', drivetrain: 'AWD',
    owners: 1, accidentFree: true,
    dealBadge: 'low-miles', dealLabel: 'Low Miles', marketSavings: 1100,
    features: ['EyeSight Driver Assist','Apple CarPlay / Android Auto','Symmetrical AWD',
      'Heated Front Seats','All-Weather Package','Blind Spot Detection',
      'Rear Cross-Traffic Alert','LED Headlights','All-Wheel Drive'],
    images: [SKETCH_IMG, SKETCH_IMG, SKETCH_IMG],
    description: 'New 2025 Impreza Premium — compact Subaru sedan with standard AWD and delivery miles only, easy to park in Rochester.',
    location: 'Greece, NY'
  },
  {
    id: 47, stockNum: 'DC10047', vin: 'JF1SKAC64N7123456',
    year: 2022, make: 'Subaru', model: 'Impreza', trim: 'Premium',
    body: 'Sedan', extColor: 'Magnetite Gray Metallic', intColor: 'Black',
    price: 27488, mileage: 23800, mpgCity: 28, mpgHwy: 36,
    engine: '2.5L 4-Cylinder', hp: 182,
    transmission: 'CVT Lineartronic', drivetrain: 'AWD',
    owners: 1, accidentFree: true,
    priorUse: 'personal', formerLease: false, formerRental: false, formerFleet: false,
    source: 'Local trade-in — Rochester owner, personal use',
    dealBadge: 'great-deal', dealLabel: 'Great Deal', marketSavings: 1300,
    features: ['EyeSight Driver Assist','Apple CarPlay / Android Auto','Symmetrical AWD',
      'Heated Front Seats','All-Weather Package','Blind Spot Detection',
      'Rear Cross-Traffic Alert','All-Wheel Drive'],
    images: [SKETCH_IMG, SKETCH_IMG, SKETCH_IMG],
    description: 'Used 2022 Impreza Premium AWD — smaller footprint than Legacy with the same snow-belt Symmetrical AWD at a lower price.',
...
function expandInventory(templates, copiesPerTemplate) {
  ...
  templates.forEach((tpl, ti) => {
    for (let copy = 0; copy < copiesPerTemplate; copy++) {
      ...
      const expandedMileage = tpl.mileage + mileageBump - 1500;
      const isNew = tpl.condition === 'new' && tpl.model !== 'Legacy';
      out.push({
        ...tpl,
        id: nextId++,
        stockNum: 'DC' + stockIdx,
        vin: tpl.vin.slice(0, 12) + String(copy).padStart(5, '0'),
        condition: tpl.model === 'Legacy' ? 'used' : tpl.condition,
        mileage: isNew
          ? Math.max(tpl.mileage, tpl.mileage + copy * 3)
          : Math.max(8000, expandedMileage),
