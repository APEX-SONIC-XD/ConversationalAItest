...
const BASE_VEHICLES = [
  ...
  {
    id: 41, stockNum: 'DC10041', vin: '5UXCR6C09N9F67890',
    year: 2022, make: 'BMW', model: 'X5', trim: 'xDrive40i',
    body: 'SUV', extColor: 'Phytonic Blue Metallic', intColor: 'Cognac',
    price: 45990, mileage: 26800, mpgCity: 21, mpgHwy: 26,
    engine: '3.0L Turbocharged 6-Cyl', hp: 335,
    transmission: '8-Speed Automatic', drivetrain: 'AWD',
    owners: 1, accidentFree: true,
    dealBadge: 'great-deal', dealLabel: 'Great Deal', marketSavings: 2800,
    features: ['BMW Live Cockpit Professional','Head-Up Display','Apple CarPlay / Android Auto',
      'Harman/Kardon Audio','xDrive AWD','Panoramic Sky Lounge Roof',
      'Heated & Ventilated Front Seats','Parking Assistant Plus','Adaptive Cruise Control','M Sport Package'],
    images: [SKETCH_IMG, SKETCH_IMG, SKETCH_IMG],
    description: 'Phytonic Blue M Sport X5 — muscular stance, 335 hp turbo six, and a head-up display in a true midsize footprint.',
    location: 'Denver, CO'
  },
  {
    id: 42, stockNum: 'DC10042', vin: '5UXCR6C09N9F71234',
    year: 2022, make: 'BMW', model: 'X5', trim: 'xDrive40i',
    body: 'SUV', extColor: 'Carbon Black Metallic', intColor: 'Black',
    price: 47290, mileage: 24100, mpgCity: 21, mpgHwy: 26,
    engine: '3.0L Turbocharged 6-Cyl', hp: 335,
    transmission: '8-Speed Automatic', drivetrain: 'AWD',
    owners: 1, accidentFree: true,
    dealBadge: 'great-deal', dealLabel: 'Great Deal', marketSavings: 2400,
    features: ['BMW Live Cockpit Professional','Head-Up Display','Apple CarPlay / Android Auto',
      ...
      'Heated & Ventilated Front Seats','Parking Assistant Plus','Adaptive Cruise Control','M Sport Package'],
    images: [SKETCH_IMG, SKETCH_IMG, SKETCH_IMG],
    description: 'Carbon Black M Sport X5 — classic BMW presence, 335 hp turbo six, HUD, and xDrive AWD in a low-mile 2022.',
    location: 'Dallas, TX'
  },
  {
    id: 43, stockNum: 'DC10043', vin: '5UXCR6C09P9F84567',
    year: 2023, make: 'BMW', model: 'X5', trim: 'xDrive40i',
    body: 'SUV', extColor: 'Brooklyn Grey Metallic', intColor: 'Cognac',
    price: 52490, mileage: 18600, mpgCity: 21, mpgHwy: 26,
    engine: '3.0L Turbocharged 6-Cyl', hp: 335,
    transmission: '8-Speed Automatic', drivetrain: 'AWD',
    owners: 1, accidentFree: true,
    ...
    features: ['BMW Live Cockpit Professional','Head-Up Display','Apple CarPlay / Android Auto',
      ...
      'Heated & Ventilated Front Seats','Parking Assistant Plus','Adaptive Cruise Control','M Sport Package'],
    images: [SKETCH_IMG, SKETCH_IMG, SKETCH_IMG],
    description: 'Brooklyn Grey 2023 X5 xDrive40i — newer model year, under 19k miles, HUD and M Sport package in a sharp grey finish.',
    location: 'Plano, TX'
  },
  {
  ...
  },
  {
    ...
    year: 2022, make: 'Audi', model: 'Q5', trim: 'Premium Plus',
    body: 'SUV', extColor: 'Daytona Gray Pearl', intColor: 'Black',
    price: 37490, mileage: 22400, mpgCity: 22, mpgHwy: 28,
    ...
    features: ['Audi Virtual Cockpit','Head-Up Display','Apple CarPlay / Android Auto','Leather Seating',
  ...
  },
  {
    ...
    body: 'SUV', extColor: 'Vik Black', intColor: 'Black',
    ...
    features: ['Genesis Connected Services','Head-Up Display','Apple CarPlay / Android Auto','Leather Seating',
