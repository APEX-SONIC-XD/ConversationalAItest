...
const BASE_VEHICLES = [
  ...
  },
  {
    ...
    price: 25488, mileage: 19200, mpgCity: 26, mpgHwy: 31,
  ...
  },
  {
    ...
    price: 25490, mileage: 16500, mpgCity: 23, mpgHwy: 30,
  ...
  },
  {
    ...
    price: 25888, mileage: 19000, mpgCity: 25, mpgHwy: 30,
    engine: '1.5L Turbocharged 4-Cyl', hp: 170,
    transmission: '9-Speed Automatic', drivetrain: 'AWD',
    owners: 1, accidentFree: true,
    dealBadge: null, dealLabel: null, marketSavings: 0,
    features: ['GMC Infotainment System','Apple CarPlay / Android Auto','Leather-Appointed Seats',
      ...
      'Lane Keep Assist','Rear Park Assist','Blind Spot Monitoring','Teen Driver Technology','AWD','Roof-Mounted Cargo Rails'],
    images: [SKETCH_IMG, SKETCH_IMG, SKETCH_IMG],
  ...
  },
  {
    ...
    price: 24990, mileage: 18500, mpgCity: 24, mpgHwy: 30,
  ...
  {
    id: 40, stockNum: 'DC10040', vin: '3CZRU6H59NM123456',
    year: 2022, make: 'Honda', model: 'HR-V', trim: 'EX',
    body: 'SUV', extColor: 'Crystal Black Pearl', intColor: 'Black',
    price: 24888, mileage: 17800, mpgCity: 26, mpgHwy: 32,
    engine: '1.8L 4-Cylinder', hp: 141,
    transmission: 'CVT Automatic', drivetrain: 'AWD',
    owners: 1, accidentFree: true,
    dealBadge: 'great-deal', dealLabel: 'Great Deal', marketSavings: 1200,
    features: ['Honda Sensing Suite','Apple CarPlay / Android Auto','Adaptive Cruise Control',
      'Lane Keeping Assist','Blind Spot Monitoring','Rear Cross-Traffic Alert',
      'Heated Front Seats','Power Moonroof','All-Wheel Drive','Multi-Angle Rearview Camera'],
    images: [SKETCH_IMG, SKETCH_IMG, SKETCH_IMG],
    description: 'Compact Honda SUV with Honda Sensing standard — easy to park, strong IIHS crash scores, and the same Honda family as many teen first cars.',
    location: 'Denver, CO'
  },
  {
    id: 41, stockNum: 'DC10041', vin: '7MUAAAAG0NV234567',
    year: 2022, make: 'Toyota', model: 'Corolla Cross', trim: 'XLE',
    body: 'SUV', extColor: 'Celestite Gray Metallic', intColor: 'Black',
    price: 25588, mileage: 16500, mpgCity: 31, mpgHwy: 33,
    engine: '2.0L 4-Cylinder', hp: 169,
    transmission: 'CVT Automatic', drivetrain: 'AWD',
    owners: 1, accidentFree: true,
    dealBadge: 'low-miles', dealLabel: 'Low Miles', marketSavings: 1100,
    features: ['Toyota Safety Sense 3.0','Apple CarPlay / Android Auto','Blind Spot Monitor',
      'Rear Cross-Traffic Alert','Lane Departure Alert','Adaptive Cruise Control',
      'Heated Front Seats','Power Liftgate','All-Wheel Drive','LED Headlamps'],
    images: [SKETCH_IMG, SKETCH_IMG, SKETCH_IMG],
    description: 'Toyota\'s compact crossover with Toyota Safety Sense and IIHS Top Safety Pick credentials — a popular sibling-car size for new drivers.',
    location: 'Aurora, CO'
  },
  {
    id: 42, stockNum: 'DC10042', vin: '3MVDMBDM5NM345678',
    year: 2022, make: 'Mazda', model: 'CX-30', trim: 'Preferred',
    body: 'SUV', extColor: 'Soul Red Crystal Metallic', intColor: 'Black',
    price: 25288, mileage: 17200, mpgCity: 24, mpgHwy: 31,
    engine: '2.5L 4-Cylinder', hp: 186,
    transmission: '6-Speed Automatic', drivetrain: 'AWD',
    owners: 1, accidentFree: true,
    dealBadge: 'great-deal', dealLabel: 'Great Deal', marketSavings: 1300,
    features: ['Mazda Connect','Apple CarPlay / Android Auto','i-ACTIVSENSE Safety Suite',
      'Blind Spot Monitoring','Rear Cross-Traffic Alert','Smart Brake Support',
      'Heated Front Seats','Power Liftgate','All-Wheel Drive','Driver Attention Alert'],
    images: [SKETCH_IMG, SKETCH_IMG, SKETCH_IMG],
    description: 'Mazda\'s subcompact SUV with i-ACTIVSENSE and top crash-test scores — the same Mazda CX family many households already trust.',
    location: 'Englewood, CO'
  }
];
